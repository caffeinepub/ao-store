...
import type { ExternalBlob as _ExternalBlob, OrderData as _OrderData, OrderStatus as _OrderStatus, OrderedProduct as _OrderedProduct, Product as _Product, UserProfile as _UserProfile, UserRole as _UserRole, _CaffeineStorageRefillInformation as __CaffeineStorageRefillInformation, _CaffeineStorageRefillResult as __CaffeineStorageRefillResult } from "./declarations/backend.did.d.ts";
export class Backend implements backendInterface {
    ...
    async addProduct(arg0: string, arg1: string, arg2: number, arg3: ExternalBlob): Promise<bigint> {
        if (this.processError) {
            try {
    ...
    async getCustomerOrders(): Promise<Array<OrderData>> {
        if (this.processError) {
            try {
    ...
    async placeOrder(arg0: Array<OrderedProduct>): Promise<bigint> {
        if (this.processError) {
            try {
                const result = await this.actor.placeOrder(await to_candid_vec_n26(this._uploadFile, this._downloadFile, arg0));
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
...
async function from_candid_OrderData_n12(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: _OrderData): Promise<OrderData> {
...
async function from_candid_OrderedProduct_n17(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: _OrderedProduct): Promise<OrderedProduct> {
...
async function from_candid_record_n13(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return {
        ...
        products: await from_candid_vec_n16(_uploadFile, _downloadFile, value.products)
    };
}
async function from_candid_record_n18(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return {
        ...
        product: await from_candid_Product_n19(_uploadFile, _downloadFile, value.product)
    };
}
...
async function from_candid_vec_n11(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: Array<_OrderData>): Promise<Array<OrderData>> {
    return await Promise.all(value.map(async (x)=>await from_candid_OrderData_n12(_uploadFile, _downloadFile, x)));
}
async function from_candid_vec_n16(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: Array<_OrderedProduct>): Promise<Array<OrderedProduct>> {
    return await Promise.all(value.map(async (x)=>await from_candid_OrderedProduct_n17(_uploadFile, _downloadFile, x)));
}
...
async function to_candid_OrderedProduct_n27(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: OrderedProduct): Promise<_OrderedProduct> {
    return await to_candid_record_n28(_uploadFile, _downloadFile, value);
}
async function to_candid_Product_n29(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: Product): Promise<_Product> {
...
async function to_candid_record_n28(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return {
        quantity: value.quantity,
        product: await to_candid_Product_n29(_uploadFile, _downloadFile, value.product)
    };
}
...
async function to_candid_vec_n26(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: Array<OrderedProduct>): Promise<Array<_OrderedProduct>> {
    return await Promise.all(value.map(async (x)=>await to_candid_OrderedProduct_n27(_uploadFile, _downloadFile, x)));
}
